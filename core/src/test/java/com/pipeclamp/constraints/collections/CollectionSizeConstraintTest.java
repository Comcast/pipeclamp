...
public class CollectionSizeConstraintTest extends AbstractConstraintTest {
	...
	@Override
	protected ConstraintBuilder<?> sampleBuilder() { return CollectionSizeConstraint.Builder; }

	@Override
	protected ValueConstraint<?> sampleConstraint() { return new CollectionSizeConstraint("", false, 3, 5); }
}
